...
dashboardPage(skin = "purple",
              ...
              dashboardSidebar(
                sidebarMenu(
                  ...
                  menuSubItem("Zoho crm", href="https://www.zoho.com/login.html", icon = icon("line-chart")),
                  menuSubItem("Google analytics", href="https://accounts.google.com/Login?service=analytics", icon = icon("Google-analytics")),
                  menuSubItem("Google Adwords", href="https://adwords.google.com/um/signin", icon = icon("Google-Adwords"))
                )
              ...
              dashboardBody(
                tabItems(
                            ...
                            box(width=6, height="200px",title="Select Data", solidHeader = T, status = "primary",
                                selectInput("medium_select", 
                                            ...
                                            choices = c("All" = "total",
                                                        ...
                                                        "Referral" = "referral",
                                                        "Social" = "social")),
                                helpText("Select which channel to show in the plots below.")
                            ),
                  ...
                  tabItem(tabName = "analyse",
                          ...
                          helpText("This section demonstrates some R packages that work with time-series data. "),
                          tabBox("Select Analysis", width = 12,
                                 ...
                                 tabPanel(tagList(shiny::icon("exclamation"), "Anomaly Detection"),
                                          helpText("What dates had unusual activity?  This uses google analytics AnomalyDetection package to find unusual activity.  Fine tune the dates shown using the controls below."),
